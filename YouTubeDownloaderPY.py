...
def verify_files_and_directories():
    ...
    if os.path.exists("config.yml"):
        ...
        os.system("powershell.exe -Command \"Invoke-WebRequest -Uri https://raw.githubusercontent.com/HappyRogelio7/YouTube-Downloader-PythonV1/master/config.yml -OutFile config.yml\"")
...
def main():
    ...
    if language == "en":
        ...
        print(Fore.GREEN + "============================================================")
        print(Fore.GREEN + " Author: " + Fore.WHITE + "HappyRogelio7")
        print(Fore.GREEN + " Version: " + Fore.WHITE + "1.0.0")
        print(Fore.GREEN + "============================================================")
        print(Fore.GREEN + " Github: " + Fore.WHITE + "https://github.com/HappyRogelio7")
        print(Fore.GREEN + "============================================================")
    ...
    # Spanish
        ...
        print(Fore.GREEN + "============================================================")
        print(Fore.GREEN + " Autor: " + Fore.WHITE + "HappyRogelio7")
